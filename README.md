...
La aplicación permite crear una cuenta nueva o iniciar sesión para acceder a las funciones disponibles.

En caso de utilizar una cuenta de prueba:

Usuario: ejemplo@elbiofernandez.edu.uy
Contraseña: 1234
